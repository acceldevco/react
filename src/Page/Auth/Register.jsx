...
function Register() {
  return (
    <div className=" relative overflow-hidden bg-[#141619]">
        <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 max-[1200px]:[&>:nth-child(2)]:w-full max-[1200px]:[&>:nth-child(1)]:hidden rounded-[10px] [&>:nth-child(1)]:w-[60%] [&>:nth-child(2)]:w-[40%]">
          <div className="flex justify-center items-center flex-grow-0 flex-shrink-0 ">
            <div className="flex flex-col justify-center items-start flex-grow h-[984px] relative">
              <div className="self-stretch flex-grow relative bg-[#141619]">
                ...
                <div className=" h-px absolute left-[88px] top-28">
                  <div className="flex flex-col justify-start items-start w-[743px] h-[684.98px] absolute left-[81.66px] top-[19.33px] overflow-hidden">
                    <div className="flex flex-col justify-center items-center flex-grow-0 flex-shrink-0 h-[684.98px] w-[743px] relative overflow-hidden py-[10.398797035217285px]">
                      <svg
                        width={744}
                        height={665}
                        viewBox="0 0 744 665"
                      ...
                      >
                        <g clip-path="url(#clip0_636_51)">
                          <g opacity="0.4">
                            <path
                              d="M719.577 220.132C725.12 220.132 729.613 215.639 729.613 210.096C729.613 204.554 725.12 200.061 719.577 200.061C714.035 200.061 709.542 204.554 709.542 210.096C709.542 215.639 714.035 220.132 719.577 220.132Z"
                              fill="#9371DA"
                            />
                            <path
                            ...
                            <g filter="url(#filter1_f_636_51)">
                              <path
                                d="M73.1168 271.269C75.888 271.269 78.1345 269.022 78.1345 266.251C78.1345 263.48 75.888 261.233 73.1168 261.233C70.3456 261.233 68.0991 263.48 68.0991 266.251C68.0991 269.022 70.3456 271.269 73.1168 271.269Z"
                                fill="#9371DA"
                              />
                            </g>
                            <path
                            ...
                            />
                            <path
                              d="M457.007 316.305C459.778 316.305 462.025 314.059 462.025 311.287C462.025 308.516 459.778 306.27 457.007 306.27C454.236 306.27 451.989 308.516 451.989 311.287C451.989 314.059 454.236 316.305 457.007 316.305Z"
                              fill="#9371DA"
                            />
                            <g filter="url(#filter2_f_636_51)">
                              <path
                            ...
                            <path
                              d="M409.48 46.5188C415.022 46.5188 419.515 42.0258 419.515 36.4834C419.515 30.941 415.022 26.448 409.48 26.448C403.938 26.448 399.445 30.941 399.445 36.4834C399.445 42.0258 403.938 46.5188 409.48 46.5188Z"
                              fill="#9371DA"
                            />
                            <g filter="url(#filter8_f_636_51)">
                              <path
                        ...
                        <defs>
                          ...
                          >
                            ...
                            <fegaussianblur
                              ...
                              result="effect1_foregroundBlur_636_51"
                            />
                          </filter>
                          <filter
                            id="filter1_f_636_51"
                          ...
                          <clippath id="clip0_636_51">
                            <rect
                              ...
                              height="664.182"
                              fill="white"
                              transform="translate(0.659912 0.72876)"
                            />
                          </clippath>
                        </defs>
                      </svg>
                ...
                <div className="flex justify-center items-center  absolute left-[88px] top-28 px-6 pt-16">
                  <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0">
                    <div className="flex justify-center items-start self-stretch flex-grow-0 flex-shrink-0 relative px-[100px] py-1">
                      <div className="self-stretch flex-grow-0 flex-shrink-0 w-[800px] h-[800px] relative overflow-hidden bg-[url('auth-pages-anniv.8048532.png.png')]" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col justify-center items-start flex-grow-0 flex-shrink-0  p-6 rounded-[10px]">
            <div className="flex flex-col justify-start items-start self-stretch flex-grow px-px pt-px pb-[225.1999969482422px] rounded-[10px] bg-white/[0.01] border border-[#212529] backdrop-blur-[12.5px]">
              <div className="flex flex-col justify-center items-center self-stretch flex-grow-0 flex-shrink-0 h-10 pl-[156px] pr-[154px] py-[11px] rounded-tl-[10px] rounded-tr-[10px] bg-[#413825]/60">
                <div className="flex flex-row-reverse justify-between items-center flex-grow-0 flex-shrink-0 w-[360px]">
                  <div className="flex flex-row-reverse justify-start items-start flex-grow-0 flex-shrink-0 relative space-x-[-8.526512829121202e-14px] space-x-reverse pr-[8.526512829121202e-14px]">
                    <svg
                      width={18}
                      height={18}
                      viewBox="0 0 18 18"
                    ...
                    <div className="flex flex-col justify-start items-end flex-grow-0 flex-shrink-0 relative pr-1">
                      <p className="flex-grow-0 flex-shrink-0 text-[11.8125px] text-right text-white">
                        مطمئن شوید در دامنه رسمی نوبیتکس هستید
                      </p>
                    </div>
                  </div>
                  <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative pr-[9.947598300641403e-14px]">
                    <p className="flex-grow-0 flex-shrink-0 text-[11.25px] text-left">
                      <span className="flex-grow-0 flex-shrink-0 text-[11.25px] text-left text-[#fb3]">
                        https://
                      </span>
                      <span className="flex-grow-0 flex-shrink-0 text-[11.25px] text-left text-white">
                        nobitex.ir
                      </span>
                    </p>
                  </div>
              ...
              <div className="flex flex-col justify-start items-center self-stretch flex-grow-0 flex-shrink-0 relative px-[155px] pt-[60px] pb-6">
                <div className="flex flex-col">
                  <div className="flex flex-col justify-start items-end  pb-[0.8999999761581421px]">
                  ...
                  <div className="flex flex-row-reverse justify-between items-center ">
                    <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 relative">
                      <p className="flex-grow-0 flex-shrink-0 text-[11.8125px] text-center text-white">
                        قبلا ثبت نام کردید؟
                      </p>
                    </div>
                    <div className="flex flex-col justify-center items-center flex-grow-0 flex-shrink-0 h-8 relative px-2 pt-[5px] pb-1.5 rounded-[3.2px]">
                      <p className="flex-grow-0 flex-shrink-0 text-sm font-medium text-center text-[#9f7ef1]">
                        ورود
                      </p>
                    </div>
                  </div>
                  <div className="flex flex-col justify-start items-start py-2">
                    <div className="flex flex-col justify-start items-center self-stretch flex-grow-0 flex-shrink-0 gap-px pb-px">
                      <div className="flex flex-col justify-end items-end self-stretch flex-grow-0 flex-shrink-0 pb-2">
                        <div className="flex flex-col justify-end items-end flex-grow-0 flex-shrink-0  pb-[0.5px]">
                  ...
                  <Input />
                  <div className="flex flex-col justify-start items-start w-[360px]  py-2">
                  ...
                  {/* <div className="w-[358px] h-[37px] absolute left-0.5 top-[38.2px] rounded border border-[#60626b]" /> */}
                  <div className="flex flex-col justify-start items-center   pt-1 pb-2">
                    <div className="flex flex-col justify-center items-center self-stretch flex-grow-0 flex-shrink-0">
                      <div className="flex justify-center items-center flex-grow-0 flex-shrink-0 w-[360px] h-[39px] pr-[275.3399963378906px] pb-2">
                        <div className="flex justify-end items-center self-stretch flex-grow-0 flex-shrink-0 relative px-2 pt-0.5 pb-1 rounded-[3.2px]">
                          <p className="flex-grow-0 flex-shrink-0 text-xs font-medium text-right text-[#9f7ef1]">
                            تغییر نوع کپچا
                          </p>
                        </div>
                      </div>
                      <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[360px] py-1">
                        <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 px-[34px]">
                          <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 w-[326px] h-[72px] overflow-hidden pl-[127.0199966430664px] pr-px py-5 rounded-md bg-[#171730] border border-[#171730]">
                            <div className="flex flex-col justify-start items-start h-[73px]  px-4 pt-3.5">
                              <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0">
                                <div className="flex justify-start items-center self-stretch flex-grow-0 flex-shrink-0 relative gap-[1.4210854715202004e-14px]">
                                  <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative pr-4 pt-2">
                                    <p className="flex-grow-0 flex-shrink-0 text-base font-semibold text-left text-[#f8f8f8]">
                                      من ربات نیستم
                                    </p>
                                  </div>
                                  <div className="flex-grow-0 flex-shrink-0 w-[27px] h-[27px] rounded-md bg-[#171730] border-2 border-[#784ed1]" />
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="flex justify-center items-center flex-grow-0 flex-shrink-0 w-[72.75px]  pb-2">
                  ...
                  <div className="flex flex-col justify-start items-start  py-2">
                    <div className="flex flex-row-reverse justify-end items-start self-stretch flex-grow-0 flex-shrink-0 relative pl-[38.97999954223633px]">
                  ...
                  <div className="flex flex-col justify-start items-start  pt-2 pb-4">
                    <div className="flex justify-start items-center self-stretch flex-grow-0 flex-shrink-0 relative pl-[219.4499969482422px]">
                      <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 relative pb-[0.5px]">
                        <p className="flex-grow-0 flex-shrink-0 text-[13.5625px] text-center text-white">
                          کد دعوت دارید؟ (اختیاری)
                        </p>
                      </div>
                      <div className="flex flex-col justify-center items-start flex-grow-0 flex-shrink-0 absolute left-0 top-[-1.5px] pt-[0.7599999904632568px] pb-[3.240000009536743px]">
                        <svg
                          width={20}
                          height={21}
                          viewBox="0 0 20 21"
                        ...
                        >
                          <path
                            d="M13.2336 8.00156L10.0002 11.2349L6.76689 8.00156C6.44189 7.67656 5.91689 7.67656 5.59189 8.00156C5.26689 8.32656 5.26689 8.85156 5.59189 9.17656L9.41689 13.0016C9.74189 13.3266 10.2669 13.3266 10.5919 13.0016L14.4169 9.17656C14.7419 8.85156 14.7419 8.32656 14.4169 8.00156C14.0919 7.6849 13.5586 7.67656 13.2336 8.00156Z"
                            fill="white"
                          />
                        </svg>
                      </div>
                  ...
                  <div className="flex flex-row-reverse justify-center items-center w-[360px] h-10  gap-2 pl-[105.66999816894531px] pr-[97.66000366210938px] pt-[7.5px] pb-[8.5px] rounded-md bg-[#2a2c34] border border-[#2a2c34]">
                    <svg
                      width={16}
                      height={17}
                      viewBox="0 0 16 17"
                      ...
                      preserveAspectRatio="none"
                    >
                      <g clip-path="url(#clip0_636_156)">
                        <path
                          d="M15.8348 8.67984C15.8348 8.15317 15.7882 7.65317 15.7082 7.1665H8.1748V10.1732H12.4882C12.2948 11.1598 11.7282 11.9932 10.8882 12.5598V14.5598H13.4615C14.9682 13.1665 15.8348 11.1132 15.8348 8.67984Z"
                          fill="#4285F4"
                        />
                        <path
                          d="M8.17516 16.5002C10.3352 16.5002 12.1418 15.7802 13.4618 14.5602L10.8885 12.5602C10.1685 13.0402 9.25516 13.3335 8.17516 13.3335C6.0885 13.3335 4.32183 11.9269 3.6885 10.0269H1.03516V12.0869C2.3485 14.7002 5.0485 16.5002 8.17516 16.5002Z"
                          fill="#34A853"
                        />
                        <path
                          d="M3.68814 10.0269C3.52147 9.54691 3.4348 9.03357 3.4348 8.50024C3.4348 7.96691 3.52814 7.45357 3.68814 6.97357V4.91357H1.0348C0.488138 5.99357 0.174805 7.20691 0.174805 8.50024C0.174805 9.79357 0.488138 11.0069 1.0348 12.0869L3.68814 10.0269Z"
                          fill="#FBBC05"
                        />
                        <path
                          d="M8.17516 3.66667C9.35516 3.66667 10.4085 4.07334 11.2418 4.86667L13.5218 2.58667C12.1418 1.29333 10.3352 0.5 8.17516 0.5C5.0485 0.5 2.3485 2.3 1.03516 4.91334L3.6885 6.97334C4.32183 5.07334 6.0885 3.66667 8.17516 3.66667Z"
                          fill="#EA4335"
                        />
                      </g>
                      <defs>
                        <clippath id="clip0_636_156">
                          <rect
                            width={16}
                            height={16}
                            fill="white"
                            transform="translate(0.00488281 0.5)"
                          />
                        </clippath>
                      </defs>
                    </svg>
                  ...
                  <div className="flex flex-col justify-start items-start  pt-2 pb-4">
                    <div
                      className="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 h-10 relative opacity-[0.65] pl-[155.86000061035156px] pr-[155.83999633789062px] pt-[7.5px] pb-[8.5px] rounded-md border border-[#784ed1]"
                      style={{
                        background:
                          "linear-gradient(177.91deg, #814ceb -133.26%, #9f7ef1 233.26%)",
                      }}
                    >
                      <p className="flex-grow-0 flex-shrink-0 text-base font-bold text-center text-white">
                        ثبت نام
...
export const RegisterLoader = (params)=> {
